...
def airbnb_project_dbt_assets(context: AssetExecutionContext, dbt: DbtCliResource):
...
def airbnb_project_partitioned_dbt_assets(context: AssetExecutionContext, dbt: DbtCliResource):
    (
        first_partition,
        last_partition,
